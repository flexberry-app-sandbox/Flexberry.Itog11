...
namespace IIS.Itog11
{
    ...
    [View("ДоговорE", new string[] {
            ...
            "Длительность.Длительность as \'Срок действия\'",
            "Стоимость as \'Стоимость\'",
            "ДирОтдПоРабСКл as \'Фамилия директора\'",
            "ДирОтдПоРабСКл.Имя as \'Имя\'",
            "ДирОтдПоРабСКл.Отчество as \'Отчество\'",
            "Клиент as \'Фамилия клиента\'",
            "Клиент.Имя as \'Имя\'",
            "Клиент.Отчество as \'Отчество\'"})]
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog11.Статус fСтатус;
        
        private IIS.Itog11.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private IIS.Itog11.Клиент fКлиент;
        
        private IIS.Itog11.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        
        private IIS.Itog11.Длительность fДлительность;
        ...
        public virtual IIS.Itog11.Статус Статус
        {
            get
            {
                ...
                IIS.Itog11.Статус result = this.fСтатус;
        ...
        public virtual IIS.Itog11.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Itog11.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Itog11.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Itog11.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Длительность"})]
        [NotNull()]
        public virtual IIS.Itog11.Длительность Длительность
        {
            get
            {
                ...
                IIS.Itog11.Длительность result = this.fДлительность;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Itog11.Клиент Клиент
        {
            get
            {
                ...
                IIS.Itog11.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Itog11.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Itog11.Договор));
                }
            }
        }
    }
