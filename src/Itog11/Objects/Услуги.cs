...
namespace IIS.Itog11
{
    ...
    [View("УслугиE", new string[] {
            ...
            "ЗатрВремя.ЗатрВремя as \'Затраченное время\'"})]
    ...
    public class Услуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog11.Услуга fНаименование;
        
        private IIS.Itog11.ЗатрВремя fЗатрВремя;
        ...
        public virtual IIS.Itog11.Услуга Наименование
        {
            get
            {
                ...
                IIS.Itog11.Услуга result = this.fНаименование;
        ...
        [PropertyStorage(new string[] {
                "ЗатрВремя"})]
        [NotNull()]
        public virtual IIS.Itog11.ЗатрВремя ЗатрВремя
        {
            get
            {
                ...
                IIS.Itog11.ЗатрВремя result = this.fЗатрВремя;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугE", typeof(IIS.Itog11.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугL", typeof(IIS.Itog11.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиE", typeof(IIS.Itog11.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиL", typeof(IIS.Itog11.Услуги));
                }
            }
        }
    }
