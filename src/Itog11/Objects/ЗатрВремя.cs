    ...
    public class ЗатрВремя : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗатрВремяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗатрВремяE", typeof(IIS.Itog11.ЗатрВремя));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗатрВремяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗатрВремяL", typeof(IIS.Itog11.ЗатрВремя));
                }
            }
        }
    }
